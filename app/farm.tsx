...
const npcs: NPCProps[] = [
  ...
  },
  {
    ...
    personality: "If you are looking for logical and straight-forward advices on your study, look no further than Talon the Hawk. He is a wise and logical bird who is always ready to help you with your study.",
  ...
  },
  {
    ...
    personality: "Gabby the Goose might be a bit too chatty for some, but you would definitely be amused by her quirky personality. She is always ready to share her stories and experiences with you.",
